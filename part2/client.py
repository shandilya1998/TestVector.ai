...
if __name__ == '__main__':
    while(True):
        ...
        push_payload(payload, params['PUB_SUB_TOPIC'], params['PUB_SUB_PROJECT'])
        consume_payload(params['PUB_SUB_PROJECT'], params['PUB_SUB_SUBSCRIPTION'], process_payload, params['timeout'])
        time.sleep(3)
